...
function NavBar() {
    ...
    return (
    <nav className="border-b mb-4 border-blue-900/95 shadow-sm shadow-blue-900 rounded-lg p-2 sticky flex items-center justify-between top-0 z-10 container mx-auto  max-w-[1280px] xl:mx-auto">
